...
class InactiveHistoricProductScreen extends StatefulWidget {
  ...
  @override
  State<InactiveHistoricProductScreen> createState() => _InactiveHistoricProductScreenState();
}

class _InactiveHistoricProductScreenState extends State<InactiveHistoricProductScreen> {
                ...
                if (!snapshot.hasData) {
                  ...
                  return _data.data(snapshot.data!.docs, false).length == 0
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ProductTile(
                          page: 6,
                          title: "Você deseja reativar o produto ${data[index]["titulo"]} ?",
                          subtitle: "Para inativa-lo, consulte o histórico de inativos!",
                          label: "Reativar",
                          color:Colors.green,
                          button: true,
                          "list",
