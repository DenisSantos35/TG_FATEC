...
import 'edit_client_tile.dart';

class EditClienteMolecules extends StatefulWidget {
  DataClientesController controller;
  EditClienteMolecules({Key? key, required this.controller}) : super(key: key);

  @override
  State<EditClienteMolecules> createState() => _EditClienteMoleculesState();
}

class _EditClienteMoleculesState extends State<EditClienteMolecules> {
  String _searchText = '';
